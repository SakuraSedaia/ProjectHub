        ...
        <div class={"standard-container"}>
          ...
          <div class={"feature-grid"}>
            <div class={"feature-card"}>
              ...
              <h3>Lightweight</h3>
              <p>Optimized for performance while maintaining a high level of detail and flexibility.</p>
            </div>
            <div class={"feature-card"}>
              <div class={"feature-icon"}>
              ...
              <h3>Customizable</h3>
              <p>Highly flexible rig structure developed and refined since 2019 for professional use.</p>
            </div>
            <div class={"feature-card"}>
              <div class={"feature-icon"}>
              ...
              <h3>Integrated UI</h3>
              <p>Seamlessly integrates with the Sakura Rig Utilities extension for advanced controls.</p>
            </div>
            <div class={"feature-card"}>
              <div class={"feature-icon"}>
              ...
              <p>Used by animators worldwide for high-quality Minecraft-themed animations.</p>
            </div>
          </div>
        </div>
      </section>
