        ...
        <div class={"standard-container"}>
          <div class={"instruction-blocks"}>
            <div class={"instruction-card"}>
              ...
              <p>The easiest way to stay up-to-date via the Blender Extensions platform.</p>
              <ol class={"styled-list"}>
                <li>Open Blender and navigate to <strong>Edit &gt; Preferences &gt; Get Extensions</strong>.</li>
            ...
            <div class={"instruction-card"}>
              ...
              <ol class={"styled-list"}>
                <li>Download the <code>.zip</code> release from the downloads section above.</li>
